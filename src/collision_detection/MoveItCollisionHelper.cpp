...
namespace my_collision_detection {
    MoveItCollisionHelper::MoveItCollisionHelper(const std::string &yaml_name,
                                                 const std::string &group_name,
                                                 const kinematics::analytical_ik_handled_t &analytical_ik_func)
            : _robot_model_loader_ptr(new robot_model_loader::RobotModelLoader("robot_description")),
              ...
              _kinematics_ptr(new kinematics::Kinematics(yaml_name, analytical_ik_func)),
    ...
    bool MoveItCollisionHelper::isStateValid(const state_space::JointSpace &state)
    {
        ...
        _planning_scene_ptr->checkCollision(_collision_request, _collision_result, current_state);
    ...
    MoveItCollisionHelper::allValidSolutions(const state_space::SE3 &desired_pose,
    ...
    bool MoveItCollisionHelper::nearestSolution(state_space::JointSpace& solution,
